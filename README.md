...
- [什么是验证码？能否自动化？](#什么是-验证码-能否自动化)
- [验证码与 Cypress：一段艰难的关系](#验证码-与-cypress-一段艰难的关系)
- [如何在 Cypress 中处理验证码](#如何在-cypress-中处理-验证码)
  - [方法一：禁用验证码](#方法一-禁用-验证码)
  - [方法二：自动化与验证码的交互](#方法二-自动化与-验证码-的交互)
